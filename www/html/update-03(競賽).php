...
?>
    ...
    <div style="text-align:center;width:100%;height:50px;">
        ...
        <h2 class="margin_top50">修改資訊</h2><br>
            <form method="post" action="dbeditlist.php?ID=<?php echo $datas[0]['ID']?>">
                比賽名稱：<input type="text" class="form-control" value="<?php echo $datas[0]['name'] ?>" name="name"><br>
                比賽資訊：<input type="text" class="form-control" value="<?php echo $datas[0]['inform'] ?>" name="inform"><br>
