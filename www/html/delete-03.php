                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="banner-content">
                            <h2 class="text-white">修改/刪除資料</h2>
...
?>
      ...
      <body>
      <section id="service" class="service-section pt-10 pb-05">
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-7 col-md-9 mx-auto">
                <div class="section-title text-center mb-55">
                    <span class="wow fadeInDown" data-wow-delay=".2s"><h2>修改/刪除資料</h2></span>
                </div>
            </div>         
        </div>
                ...
                <tbody>
                    <tr class="table-danger">
                        ...
                        for ($i = 0; $i < $datas_len; $i++) {
                          echo "<tr>";
                          echo "<td>" . ($i + 1) . "</td>";
                          echo "<td>" . $datas[$i]['name'] . "</td>";
                          echo "<td>" . $datas[$i]['inform'] . "</td>";
                          echo "<td>" . $datas[$i]['link'] . "</td>";                           
                          echo "<td>
                            <a href='content-03(內容).php?ID=".$datas[$i]['ID']."'><button class='btn btn-success'>詳細</button></a>
                            <a href='update-03(競賽).php?ID=".$datas[$i]['ID']."'><button class='btn btn-success'>修改</button></a>
                            <a href='dbdelete-03.php?pk=".$datas[$i]['ID']."'><button class='btn btn-success'>刪除</button></a>
                            </td>";
                        }
                        ?>
                    </tr>
