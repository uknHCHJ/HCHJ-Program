  ...
  data.forEach(function(item) {
    ...
    console.log('正在處理項目:', item); // 檢查每一行資料
        if (item.Permissions === '1') {
            ...
            var url = 'Change-permissions.html?username=' + encodeURIComponent(item.user) + '&permission=' + encodeURIComponent(item.Permissions);
