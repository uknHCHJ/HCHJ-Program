                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="nav-item active"><a href="index.html">查看個人資料</a></li>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="nav-item"><a href="Contest-history1.php">學生競賽歷程</a></li>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="nav-item"><a href="/~HCHJ/Home/blog-1.html">新增比賽資訊/修改</a></li> 
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="banner-content">
                            <h2 class="text-white">學生志願序管理</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item" aria-current="page"><a href="index-04.php">首頁</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">學生志願序</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-7 col-md-9 mx-auto">
                ...
                <select id="table-select" class="form-select mb-4" onchange="fetchStudentData()">
                    ...
                    <option value="忠">資五忠</option>
                    <option value="孝">資五孝</option>
                </select>  
            </div>
...
function updateStudentTable(data) {
  ...
  data.forEach(function(item) {
    ...
    button.onclick = function() {
      window.location.href = 'order2.php?user=' + item.user;
    };
