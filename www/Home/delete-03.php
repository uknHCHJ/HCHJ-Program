                    ...
                    <tbody>
                        <?php foreach ($datas as $index => $data) : ?>
                            <tr>
                                ...
                                <td><?= $data['name'] ?></td>
                                <td>
                                    <a href="content-03(內容).php?ID=<?= $data['ID'] ?>" class="btn btn-secondary">詳細</a>
                                    <a href="update-03(競賽).php?ID=<?= $data['ID'] ?>" class="btn btn-success">修改</a>
                                    <a href="dbdelete-03.php?pk=<?= $data['ID'] ?>" onclick="return confirm('確定要刪除該比賽資訊嗎？')" class="btn btn-danger">刪除</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
