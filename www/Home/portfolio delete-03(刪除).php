                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">                                    
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll active dd-menu" href="portfolio-03(二技校園網介紹).php">二技校園網介紹</a>           
                                        <ul class="sub-menu">
                                        ...
                                        <li class="nav-item"><a href="portfolio delete-03(刪除).php">刪除</a></li>
                                        </ul>
                                    </li>        
                                    <li class="nav-item">
...
$sql = "SELECT ID, school_name, area, inform, link FROM volunteer";// sql語法存在變數中
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-7 col-md-9 mx-auto">
                <div class="section-title text-center mb-55">
                    <span class="wow fadeInDown" data-wow-delay=".2s"><h2>二技學校</h2></span>
                </div>
            </div>         
        </div>
                ...
                <tbody>
                    <tr class="table-danger">
                        ...
                        for ($i = 0; $i < $datas_len; $i++) {
                          echo "<tr>";
                          echo "<td>" . ($i + 1) . "</td>";
                          echo "<td>" . $datas[$i]['school_name'] . "</td>";
                          echo "<td>" . $datas[$i]['area'] . "</td>";
                          echo "<td>" . $datas[$i]['inform'] . "</td>";          
                          echo "<td>" . $datas[$i]['link'] . "</td>";                  
                          echo "<td>
                            <a href='dbportfolio(修改)-03.php?id=".$datas[$i]['ID']."'><button class='btn btn-success'>修改</button></a>
                            <a href='dbportfolio(刪除)-03.php?id=".$datas[$i]['ID']."'><button class='btn btn-success'>刪除</button></a>
                                </td>";
                        }
                        ?>
                    </tr>
