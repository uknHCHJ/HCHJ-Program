                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                ...
                                <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">                                        
                                        <li class="nav-item"><a href="portfolio-03(二技校園網介紹).php">校園介紹</a></li>
                                        <li class="nav-item"><a href="portfolio-03(二技科系).php">校園科系總覽</a></li>
                                        </ul>
                                    </li>    
                                    <li class="nav-item">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-7 col-md-9">
                <div class="section-title text-center mb-55">                    
                    <span class="wow fadeInDown" data-wow-delay=".2s"><h2 style="font-size: 1.6em;">總覽</h2></span>
                </div> 
            </div>         
        </div>
        <div class="row justify-content-center">
            <div class="col-md-8">
                <table class="table table-hover text-center" id="list_table" style="font-size: 1.5em; line-height: 1.5;">
                    <thead>
                        <tr>
                            <th style="width: 10%;">序號</th>
                            <th style="width: 50%;">學校名稱</th>
                    ...
                    <tbody>
                        <?php foreach ($datas as $index => $data) : ?>
                            <tr>
                                <td><?= $index + 1 ?></td>
                                <td><?= htmlspecialchars($data['school_name']) ?></td>
                                <td>
                                    <h4><a href="portfolio student-03(顯示科系) .php?school_id=<?= $data['school_id'] ?>" class="btn btn-primary">科系</a></h4>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
