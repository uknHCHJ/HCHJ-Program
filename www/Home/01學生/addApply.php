...
// 先刪除該學生的舊資料
$deleteStmt = $conn->prepare("DELETE FROM Apply WHERE student_user = ?");
if (!$deleteStmt) {
...
// 刪除舊資料成功，開始插入新的資料
$stmt = $conn->prepare("INSERT INTO Apply (school_name, department_name, student_user, preference_rank) VALUES (?, ?, ?, ?)");
