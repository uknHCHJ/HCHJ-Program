...
?>
            ...
            <?php foreach ($departments as $department) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="dbportfolio(刪除科系)-03.php?department_id=<?= $department['department_id'] ?>&school_id=<?= $school_id ?>" class="btn btn-primary" onclick="return confirm('確定要刪除該科系資料嗎？')">刪除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <a href="portfolio create-03(科系).php?school_id=<?= $school_id ?>" class="btn btn-success">新增</a><br>
    <a href="portfolio delete-03(編輯).php" class="btn btn-secondary">返回上一頁</a>
</section>
</body>
<!-- ========================= service-section end ========================= -->
