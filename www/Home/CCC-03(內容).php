                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="page-scroll active dd-menu">二技校園網介紹</a>
                                    <ul class="sub-menu">
                                        <li class="nav-item"><a href="portfolio-03(二技校園網介紹).php">二技校園網介紹</a></li>
                                        <li class="nav-item"><a href="portfolio create-03(新增).php">新增</a></li>
                                        <li class="nav-item"><a href="portfolio delete-03(編輯).php">編輯</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll active dd-menu">比賽資訊</a>
                                    <ul class="sub-menu">
                ...
                <div class="col-md-6">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" value="<?php echo $datas[0]['name'] ?>"
                                disabled>
                        </div><br>
                        <div class="form-group">
                            <div class="form-group">
                                <label for="inform">比賽資訊：</label>
                                <textarea class="form-control" id="inform" rows="5"
                                    disabled><?php echo $datas[0]['inform']; ?></textarea>
                            </div><br>
                            <div class="form-group">
                                <label for="link">比賽連結：</label>
                                <input type="text" class="form-control" id="link"
                                    value="<?php echo $datas[0]['link'] ?>" disabled>
                            </div><br>
                            <div class="form-group">
                                <label for="imgname">圖片：</label>
                                <input type="file" class="form-control-file" id="imgname"
                                    value="<?php echo $datas[0]['imgname'] ?>" disabled>
                            </div>
                    </form>
                </div>
            </div>
