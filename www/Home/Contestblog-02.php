                                            ...
                                            <div class="col-12 mb-4">
                                                <div class="portfolio-item-wrapper">
                                                    <div class="portfolio-img">
                                                        <img src="data:image/jpeg;base64,<?= base64_encode($competition['image']) ?>"
                                                    ...
                                                    <div class="portfolio-content mt-2">
                                                        ...
                                                        <p class="small-text">
                                                            <?= htmlspecialchars($competition['inform']) ?></p>
                                                        <a href="<?= htmlspecialchars($competition['link']) ?>"
                                                            class="theme-btn border-btn" target="_blank">查看詳細資料</a>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="sidebar-wrapper">
                        ...
                        <div class="sidebar-box search-form-box mb-30">
                            <form action="Contestsearch1-02.php" method="GET" class="search-form">
