                    ...
                    <tbody>
                        <?php foreach ($datas as $index => $data) : ?>
                            <tr>
                                ...
                                <td><?= $data['name'] ?></td>
                                <td>
                                    <a href="Contestupdate1-02.php?ID=<?= $data['ID'] ?>" class="btn btn-success">修改</a>
                                    <a href="ContestDelete2-02.php?pk=<?= $data['ID'] ?>" onclick="return confirm('確定要刪除該比賽資訊嗎？')" class="btn btn-danger">刪除</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
