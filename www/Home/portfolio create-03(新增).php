...
?>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                ...
                                <li class="nav-item">              
                                        <li class="nav-item"><a href="Schoolnetwork1.php">二技校園介紹網</a></li>
                                    </li>    
                                    <li class="nav-item">
    ...
    <div class="form-container">
        <h2>二技校園</h2>
        <form action="dbportfolio(新增)-03.php" method="post" enctype="multipart/form-data"><br>
