                                ...
                                <tbody>
                                    <?php foreach ($filtered_schools as $index => $school) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="portfolio create-04(顯示科系).php?school_id=<?= $school['school_id'] ?>" class="btn btn-info">科系</a>
                                                <a href="portfolio update-04(修改).php?school_id=<?= $school['school_id'] ?>" class="btn btn-success">修改</a>
                                                <a href="dbportfolio(刪除學校)-04.php?school_id=<?= $school['school_id'] ?>" class="btn btn-danger" onclick="return confirm('確定要刪除該學校及其關聯科系資料嗎？')">刪除</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
