...
?>
                    ...
                    <div class="banner-content">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index-04.php">首頁</a></li>
    ...
    <div style="text-align:center;width:100%;height:50px;">
        <div style="width:70%;height:20px;margin:0 auto;">
            ...
            <br><br>
            <form action="dbportfolio(科系)-04.php" method="post" enctype="multipart/form-data">
                ...
                <br><br>
                <a href="portfolio create-03(顯示科系).php?school_id=<?= $school_id ?>" class="btn btn-secondary">返回上一頁</a>
