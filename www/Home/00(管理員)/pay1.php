                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="banner-content">
                            <h2 class="text-white">繳交狀態查詢</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item" aria-current="page"><a href="index-04.php">首頁</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">繳交狀態查詢</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
...
<section id="service" class="service-section pt-130 pb-100">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-7 col-md-9 mx-auto">
                <div class="section-title text-center mb-55">
                    <span class="wow fadeInDown" data-wow-delay=".2s">學生名單</span>
                </div>
    ...
    if (in_array($Permissions, ['2'])) {
        ...
        // 如果是學生，只顯示自己的班級（假設 $userClass 的值與 $classes 的 key 相同）
        if (!empty($userClass) && isset($classes[$userClass])) {
            echo "<option value='{$userClass}'>{$classes[$userClass]}</option>";
        }
    }
    ?>
</select>
...
function updateStudentTable(data) {
  ...
  data.forEach(function(item) {
    ...
    button.onclick = function() {
      window.location.href = 'check-order1.php?user=' + item.user + '&name=' + encodeURIComponent(item.name);
    };
