...
$sql = "SELECT * FROM assing WHERE vid='".$adm_pk."'"; // sql語法存在變數中
...
?>
    ...
    <div style="text-align:center;width:100%;height:50px;">
        ...
        <h2 class="margin_top50">全部</h2><br>
            <form method="post" action="dbportfolio(科系)-03.php?ID=<?php echo $datas[0]['ID']?>">
                科系：<input type="text" class="form-control" value="<?php echo $datas[0]['ID'] ?>" name="ID"><br>
