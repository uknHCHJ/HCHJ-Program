...
?>
            ...
            <?php foreach ($departments as $department) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="DeleteDepartment2.php?department_id=<?= $department['department_id'] ?>&school_id=<?= $school_id ?>" class="btn btn-primary" onclick="return confirm('確定要刪除該科系資料嗎？')">刪除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <a href="AddDepartments1.php?school_id=<?= $school_id ?>" class="btn btn-success">新增</a><br>
    <a href="SchoolEdit1.php" class="btn btn-secondary">返回上一頁</a>
</section>
</body>
<!-- ========================= service-section end ========================= -->
