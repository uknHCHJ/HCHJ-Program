                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                ...
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="nav-item"><a href="/~HCHJ/Home/blog-1(競賽).html">查看</a></li>
                                            <li class="nav-item"><a href="/~HCHJ/Home/blog-1(競賽).html">新增</a></li>
                                            <li class="nav-item"><a href="/~HCHJ/Home/blog-1(競賽).html">編輯</a></li>
                                        </ul>                                       
                                    </li>
                                    <li class="nav-item">
